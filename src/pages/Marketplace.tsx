    ...
    <label className="block text-sm mb-3">
      ...
      <div className="relative mt-1">
        <input
          ...
          className="w-full border border-black pl-3 pr-11 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-black"
        />
        <button
          onClick={triggerSearch}
          className="absolute right-1 top-1/2 -translate-y-1/2 p-2 bg-black text-white hover:bg-black/80 transition"
          title="Search"
        >
          <svg 
